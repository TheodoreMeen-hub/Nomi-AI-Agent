...
# 项目文档
1. [第1轮：需求定义与方案定型](./AI项目前期需求定义和方案定型.docx)
2. [第2轮：用户调研与体验分析](./AI用户调研与用户体验分析.docx)
3. [第3轮：核心流程与Coze原型实现](./.docx)
4. [第4轮：风险管控与BadCase治理](./AI风险管控与BadCase治理.docx)
5. [第5轮：业务价值闭环与迭代规划](./AI业务价值闭环与项目迭代规划.docx)
